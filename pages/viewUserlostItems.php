          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <?php
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM items WHERE stud_num = $student AND lost = 1");
                    ?>
                  ...
                  <table class="table">
                   <thead class=" text-primary">
                    ...
                    <tr>
                        ...
                        <td><a href="includes/updatelostItemdb.php?itemId=<?php echo $row["itemId"]; ?>" title='Update Record'><button class = "btn btn-success">Edit</button></a></td>
                    ...
                    function delet(delid){
                      if(confirm("Are You Sure Want To Detele This Item !!!")){
                        window.location.href='includes/deletelostItemdb.php?del_id=' +delid+'';
                        return true;
                      }
                    }
                    </script>
          ...
          <div class="col-md-12">
            <div class="card card-plain">
              ...
              <h4 class="card-title"> All the items declared to the system</h4>
                <p class="category"> As a user you can edit and update the details you items</p>
              </div>
              <div class="card-body">
              </div>
            </div>
