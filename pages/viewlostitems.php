                  ...
                  <table class="table">
                   <thead class=" text-primary">
                    ...
                    <tr>
                        ...
                        <td><a href="includes/updatelostitems.php?itemId=<?php echo $row["itemId"]; ?>" title='Update Record'><button class ="btn btn-success">Edit</button></a></td>
                    ...
                    function delet(delid){
                      if(confirm("Are You Sure Want To Detele This Item !!!")){
                        window.location.href='includes/deletelostitems.php?del_id=' +delid+'';
                        return true;
                      }
                    }
                    </script>
