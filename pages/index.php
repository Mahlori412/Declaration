...
<html lang="en" dir="ltr">
  ...
  <body>
    <!-- Navigation -->
    <nav class="navbar navbar-expand-lg navbar-inverse navbar-dark bg-dark sticky-top">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="nav navbar-nav navbar-right" >
                ...
                <li class="nav-item">
                  <a class="nav-link" href="register.php"><span class="glyphicon glyphicon-user"></span> Create Account</a>
                </li>
                <li class="nav-item" >
    ...
    <div class="container-fluid padding">
        <div class="col-12">
          <h1 class="display-4" style = "text-align: center;">Students</h1>
          <hr>
        </div>
    </div>
