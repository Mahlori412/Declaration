        ...
        <div class="row">
                  ...
                  <table class="table">
                   <thead class=" text-primary">
                    ...
                    <tr>
                        ...
                        <td><a href="includes/update.php?stud_num=<?php echo $row["stud_num"]; ?>" title='Update Record'><button class =  "btn btn-success">Edit</button></a></td>
                
                        <td><input type="button" class = "btn btn-danger" onClick="delet(<?php echo $row["stud_num"];  ?>)" name = "delete" value="delete"></td>
                        </td>
                    </tr>
                    <script language ="javascript">
                    function delet(delid){
                      if(confirm("Are You Sure Want To Detele This Student Number " +delid+ " !!!")){
          ...
          <div class="col-md-12">
            <div class="card card-plain">
              <div class="card-header">
                <h4 class="card-title"> All the student registered to the system</h4>
